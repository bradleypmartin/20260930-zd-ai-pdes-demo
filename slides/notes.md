...
slides per part, and a links slide for the Q&A. Timings assume about two
minutes per content slide, with the clips inside Part 2. Rehearse on Sep 29;
if it runs long, trim the reactions and the questions on slide 10 first, then
the collaboration slide. Clips play from `slides/clips.html` (open in Chrome,
`F` for full screen, `1`/`2`/`3` to play each from the start); the files are
in `slides/videos/`.

| PDF page | Time | Cue |
| --- | --- | --- |
| 1–2 | 0:00–1:30 | Title; why this talk |
| 3–10 | 1:30–14:30 | Part 1, seven slides |
| 11–17 | 14:30–26:00 | Part 2, seven slides, three clips (~30 s total) |
| 18–19 | 26:00–30:00 | Comparison table; links; questions |
...
## 4. Fluids, Newton, and a question from 1934 (1:30)
...
## 6. The claim, and the picture behind it (5:15)
...
## 8. The parallel story, and the dispute (9:00)
...
## 9. What machine-checked means (11:00)
...
## 10. Reactions, and questions to argue about (12:30)
...
## 12. My corner of this world (14:30)
...
## 17. What the collaboration looked like (24:00)
